...
PanelWindow {
    ...
    // Niri port: use screen.devicePixelRatio for scale; window region mode returns empty list
    ...
    ScreencopyView {
        ...
        DragManager {
            ...
            property var hoveredWindow: null // Niri port: window selection not supported
